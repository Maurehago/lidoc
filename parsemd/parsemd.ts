...
export function parseMd(mdString :string) :SiteInfo {
    // ====================
    //   Tag namen
    // ------------------
    ...
    let closeAllTags = function() {
        ...
        if (isList) {htmlString += "</" + listTag + ">"; isList = false;}
        if (isTable) {htmlString += "</tr></thead><tbody></tbody></table>"; isTable = false;}
    ...
    let checkText = function(text: string) :string {
        ...
        while(linkPos2 > 0) {
            ...
            if (bildPos1 >= 0 && bildPos1 < linkPos2) {
                ...
                // BildLink
                newText = part1 + "<img tag='" + part2 + "' src='" + part3 + "'>" + part4;
                ...
                // Link
                newText = part1 + "<a href='" + part3 + "'>" + part2 + "</a>" + part4;
    ...
    let checkLine = function() {
        ...
        if (trimLine.endsWith("]")) {
            ...
            if (pos1 >= 0) {
                tagAttribute = " " + trimLine.substring(pos1 +2, trimLine.length -1);
